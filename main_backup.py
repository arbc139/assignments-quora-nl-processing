...
time_logger.log_with_elapse('Step4: Rebalancing data time:')
...
time_logger.log_with_elapse('Step5: Over sampling time:')
...
time_logger.log_with_elapse('Step6: Split validation data from train data time:')
...
time_logger.log_with_elapse('Step7: Run XGBoost time:')
print('Done.')